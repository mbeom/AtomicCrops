...
HRESULT HeartBag::init()
{
	return S_OK;
}

HRESULT HeartBag::init(float x, float y, int num)
{
	price = 200;
	...
	int font_size = 20;
	bottom_title.description = L"ÇÏÆ® ¾¾¾Ñ";
	...
	bottom_description.description = L"ÇÏÆ® ¾¾¾ÑÀ» 1°³ È¹µæÇÕ´Ï´Ù";
...
HRESULT HeartBag::init(float x, float y, bool is_taken)
{
	return S_OK;
}

void HeartBag::release()
{
}
